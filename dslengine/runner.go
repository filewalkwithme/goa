...
func init() {
	dslPackages = map[string]bool{
		"github.com/filewalkwithme/goa/":            true,
		"github.com/filewalkwithme/goa/middleware/": true,
		"github.com/filewalkwithme/goa/encoding/":   true,
		"github.com/filewalkwithme/goa/logging/":    true,
	}
}
