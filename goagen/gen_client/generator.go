...
func (g *Generator) generateClient(clientFile string, clientPkg string, funcs template.FuncMap) (err error) {
	...
	for packagePath := range im {
		if packagePath != "github.com/filewalkwithme/goa" {
	...
	imports := []*codegen.ImportSpec{
		...
		codegen.SimpleImport("github.com/filewalkwithme/goa"),
		codegen.NewImport("goaclient", "github.com/filewalkwithme/goa/client"),
		codegen.NewImport("uuid", "github.com/filewalkwithme/goa/uuid"),
	}
